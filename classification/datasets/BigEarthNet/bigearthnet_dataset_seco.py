...
class Bigearthnet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for b in self.bands:
            ...
            ch_img = Image.fromarray(ch.astype(np.uint8))
            
            # Resize the image using Pillow with BICUBIC interpolation
            ch_resized = ch_img.resize((128, 128), Image.BICUBIC)
            
            # If you need to convert back to a numpy array for further processing:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/mnt/disk1/tritd/SSL4EO-Review/data/BigEarthNet')
    parser.add_argument('--save_dir', type=str, default='/mnt/disk1/tritd/SSL4EO-Review/data/BigEarthNet/dataload_op1_lmdb')
