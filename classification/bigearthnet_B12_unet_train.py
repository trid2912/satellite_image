...
parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints/unet/')
parser.add_argument('--checkpoint_path', type=str, default='./checkpoints')
parser.add_argument('--resume', type=str, default='')
parser.add_argument('--save_path', type=str, default='./checkpoints/bigearthnet_s2_B12_100_no_pretrain_unet.pt')
...
def main():
    ...
    net = UNet(num_classes = 19, input_channels = 12)
    '''
    ...
    for epoch in range(last_epoch,epochs):
        ...
        for i, data in enumerate(train_loader, 0):
            ...
            outputs = net(inputs)
            #pdb.set_trace()
            print(outputs.shape, labels.shape, outputs.long().shape, labels.long().shape)
